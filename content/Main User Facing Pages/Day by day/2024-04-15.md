...
- [x] Make it easier to implement Python projects into Obsidian, without having to duplicate my script running plug-in each time. Then, implement (at least) the chess PGN to JSON conversion script into a chess daily game template. 🔒 [[2024-04-15]] 🕸️ The Scholar's Ledger
- [x] Complete my chess engine (or re-do). 🔒 [[2024-04-15]] 🕸️ The Scholar's Ledger
- [x] Complete my sudoku engine (or re-do). 🔒 [[2024-04-15]] 🕸️ The Scholar's Ledger
